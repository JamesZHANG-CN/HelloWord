---
title: "可链式调用微信支付OpenAPI的PHP版SDK"
date: 2021-06-17T19:26:11+08:00
lastmod: 2021-06-27T10:50:06+08:00
keywords: ["微信支付", "WeChatPay PHP SDK", "GuzzleHttp", "PHPStan Level8"]
description: "一款 PHPStan Level8 最严谨级别，用起来会觉得原来程序还可以这么自由编写的微信支付SDK——[A]Sync Chainable WeChatPay v2&v3's OpenAPI SDK for PHP"
tags: []
toc: false
categories: [php, wechat]
summary: "一款 PHPStan Level8 最严谨级别，用起来会觉得原来程序还可以这么自由编写的微信支付SDK——[A]Sync Chainable WeChatPay v2&v3's OpenAPI SDK for PHP"
author: "James"
---

## 概览

微信支付 APIv2&APIv3 的 `Guzzle HttpClient` 封装组合，
